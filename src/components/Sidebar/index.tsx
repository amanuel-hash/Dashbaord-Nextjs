    ...
    menuItems: [
      ...
      },
      {
        icon: (
          ...
          >
            <path
              d="M3 6H21V8H3V6ZM3 10H21V12H3V10ZM3 14H15V16H3V14Z"
              fill="currentColor"
            />
          </svg>
        ),
      ...
      },
      {
        icon: (
          ...
          >
            <path
              d="M12 21.35L10.55 20.03C5.4 15.36 2 12.28 2 8.5C2 5.41 4.42 3 7.5 3C9.24 3 10.91 3.81 12 5.08C13.09 3.81 14.76 3 16.5 3C19.58 3 22 5.41 22 8.5C22 12.28 18.6 15.36 13.45 20.04L12 21.35Z"
              fill="currentColor"
            />
          </svg>
        ),
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        <div className="ml-2 flex items-center justify-between gap-2 px-8 py-6">
          <Link href="/">
            <Image
              width={176}
              height={32}
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          <nav className="mt-10 px-4 lg:px-6">
